    ...
    <div className="auth-shell">
      ...
      <div className="auth-panel">
        <div className="auth-card">
          ...
          <p className="text-gray-600 mb-8">Start automating your school communications</p>
        ...
        <div className="auth-side-card text-center">
          ...
          <div className="text-left space-y-4 text-lg text-white/80">
            <div className="flex items-center gap-3">
              ...
              <p>Multi-tenant architecture for schools</p>
            </div>
            <div className="flex items-center gap-3">
              <span className="w-2 h-2 rounded-full bg-accent"></span>
              <p>Automated chatbot responses</p>
            </div>
            <div className="flex items-center gap-3">
              <span className="w-2 h-2 rounded-full bg-accent"></span>
              <p>Bulk messaging campaigns</p>
            </div>
            <div className="flex items-center gap-3">
              <span className="w-2 h-2 rounded-full bg-accent"></span>
              <p>Lead management & tracking</p>
            </div>
          </div>
        </div>
      </div>
